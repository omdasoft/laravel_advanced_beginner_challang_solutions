    ...
    <div class="col-md-12 d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                <h5 class="card-title mb-0 mr-2">Edit Task</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $task->title }}" id="title" class="form-control @error('title') is-invalid @enderror"
                                /> @error('title')
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="10" class="form-control @error('description') is-invalid @enderror">{{ $task->description }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span> 
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="dateline" value="{{ $task->dateline }}" id="dateline" class="form-control @error('dateline') is-invalid @enderror"
                                /> @error('dateline')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span> @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_id" value=" {{ old('user_id') }}"class="form-control @error('user_id') is-invalid @enderror">
                                    ...
                                    @forelse($users as $user)
                                        <option value="{{ $user->id }}" {{ $task->user_id == $user->id ? 'selected':'' }}>{{ $user->first_name }}</option>
                                    @empty
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="client_id" value=" {{ old('client_id') }}"class="form-control @error('client_id') is-invalid @enderror">
                                        ...
                                        @forelse($clients as $client)
                                            <option value="{{ $client->id }}" {{ $task->client_id == $client->id ? 'selected':'' }}>{{ $client->contact_name }}</option>
                                        @empty
